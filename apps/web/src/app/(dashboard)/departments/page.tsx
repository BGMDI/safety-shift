...
function JobSalaryFields({ value, onChange, rates }: { value: typeof emptyJob | JobTitle; onChange: (value: any) => void; rates: { basic: number; housing: number; transport: number } }) {
  ...
  return <div className="space-y-4">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <div className="field-group"><label>إجمالي راتب الدرجة الأولى <em>*</em></label><input type="number" min="0" value={value.baseSalary} onChange={e => set('baseSalary', e.target.value)} className={inp} /></div>
