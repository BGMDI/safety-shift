...
async function run() {
  ...
  sheet.getRow(2).values = ['حارس أمن', 5, 4500, 250, 0, 'بدل خطر:300|بدل موقع:200', 'نعم']
  sheet.getRow(3).values = ['محاسب', 3, 6000, 500, 200, '', 'لا']
  sheet.getRow(4).values = ['', '', '', '', '', '', '']
  sheet.getRow(5).values = ['مدير فرع', 0, -1, -2, -1, 'بدل غير صالح', 'ربما']
  sheet.getRow(6).values = [{ formula: '1+1', result: 2 }, 1, 5000, 0, 0, '', 'نعم']
